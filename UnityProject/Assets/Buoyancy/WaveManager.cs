...
public class WaveManager : MonoBehaviour
{
    ...
    {
        return GerstnerDisplacement(pos, phase, timeScale, gravity, depth, amplitude1, amplitude2, amplitude3, amplitude4, direction1, direction2, direction3, direction4).y;
    }
